# --- !Ups
-- TABLE tb_person ---------------------------------------------------------------
create table "tb_person" ("pk_id" SERIAL PRIMARY KEY NOT NULL,"dt_member_id" VARCHAR(254),"dt_name" VARCHAR(254) NOT NULL,"dt_email" VARCHAR(254),"dt_active" BOOLEAN NOT NULL);
-- TABLE tb_token ----------------------------------------------------------------
create table "tb_token" ("pk_id" SERIAL PRIMARY KEY NOT NULL,"dt_serial" bytea NOT NULL,"dt_purpose" VARCHAR(254) NOT NULL,"dt_active" BOOLEAN NOT NULL,"fk_owner_id" INTEGER NOT NULL,constraint "fk_owner" foreign key("fk_owner_id") references "tb_person"("pk_id") on update NO ACTION on delete RESTRICT);
...
create table "tb_unknown_token" ("dt_serial" bytea NOT NULL,"fk_machine_id" INTEGER NOT NULL,"dt_read_stamp" VARCHAR(50) NOT NULL,constraint "fk_machine" foreign key("fk_machine_id") references "tb_machine"("pk_id") on update NO ACTION on delete NO ACTION);
...
-- TABLE tb_user -----------------------------------------------------------------
create table "tb_user" ("pk_id" SERIAL PRIMARY KEY NOT NULL,"dt_email" VARCHAR(254) NOT NULL UNIQUE,"dt_hash" VARCHAR(254) NOT NULL);
...
create table "tb_machine_times" ("pk_id" SERIAL PRIMARY KEY NOT NULL,"fk_machine_id" INTEGER NOT NULL,"dt_weekdays" VARCHAR(254) NOT NULL,"dt_starttime" INTEGER NOT NULL,"dt_endtime" INTEGER NOT NULL);
